...
function App() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Мы подписываем договор, после которого мы внедряем ИИ-ассистента в ваши каналы связи. Вам дается 5 дней на тестирование и внесение правок. Если вас все устраивает, вы оплачиваете стоимость разработки. Далее вы можете приобрести ежесмесячную техническую поддержку."
    }
  ]
        ...
        <div className="container mx-auto px-[10px] sm:px-4 lg:px-[40px] max-w-screen-xl w-full">
          <div className="max-w-4xl mx-auto text-center w-full">
            ...
            <p className="text-lg lg:text-xl mb-12 opacity-90">
              Давайте рассчитаем стоимость вашего ИИ-ассистента, который будет работать 24/7, отвечать на вопросы клиентов и продавать ваши товары и услуги.
            </p>
            <ClientCalc />
          </div>
        </div>
